...
export default function ReplyInput({replyingTo, isVisible, user, commentId, addReply}: ReplyInputProps) {
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: "border border-grayish-blue p-4 rounded-lg outline-none h-24 overflow-y-scroll",
            },
        },
    ...
    function onSendReply() {
        ...
        editor?.commands.setContent(`<span data-type='mention' data-id='${replyingTo.username}'></span>&nbsp;`);
    }
